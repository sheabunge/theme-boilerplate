...
/**
 * Used for displaying an attachment image page
 *
 * @since      0.1
				...
				<div class="entry-content">
					...
					if ( has_excerpt() ) {
						...
						echo do_shortcode( sprintf(
							'[caption align="aligncenter" width="%1$s"]%3$s %2$s[/caption]',
							esc_attr( $src[1] ),
							get_the_excerpt(),
					...
					wp_link_pages( array(
						'before' => '<p class="page-links">' . __( 'Pages:', 'theme-boilerplate' ),
						'after' => '</p>'
					) );
			...
			<div class="attachment-meta">
				...
				if ( ! empty( $gallery ) ) { ?>
					<div class="image-gallery">
						<h3><?php _e( 'Gallery', 'theme-boilerplate' ); ?></h3>
						<?php echo $gallery; ?>
					</div>
				}
